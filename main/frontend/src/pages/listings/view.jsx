      ...
      <div className="content">
        ...
        <div className="view-data">
          <ul>
            ...
            <li><span>Car:</span><Link to={`/cars/${data?.car_id}`}>{data?.car}</Link></li>
            <li><span>From:</span>{new Date(data?.fromDate).toString()}</li>
            <li><span>To:</span>{new Date(data?.toDate).toString()}</li>
            <li><span>Owner:</span><Link to={`/users/${data?.owner}`}>{owner?.username}</Link></li>
